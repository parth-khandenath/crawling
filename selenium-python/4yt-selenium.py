    ...
    try:
        ...
        for book_link in book_urls:
            ...
            if weekly_recomendations=="" or weekly_recomendations=="-":
                weekly_recomendations="NA"
            ans.loc[len(ans.index)]=[title,'4yt-'+str(book_id),author,tags,approx_num_chapts,status,approx_novel_start,last_chapter_time,words,book_link,reads,total_recomendations,weekly_recomendations]
