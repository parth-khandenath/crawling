...
head2 = {'Show ID':[],'title':[],'Description':[],'Author':[],'VOA':[],'Production House':[],'Language':[],'type':[],'Category Type':[],
         ...
         'Maturity':[],'Gender Pref':[],'Locking Episode':[],'Moderation':[],'AI':[],'Plays':[],'Duration':[],'Likes':[],'Rating':[],'Rating count':[],'Subscriber count':[],'published_episodes_count':[],'shares':[],'editor_score':[],'category':[],'sub genre':[],'status':[]} 
