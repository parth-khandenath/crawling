...
playlist_ids=[]
playlist_ids=['UUQatgKoA7lylp_UzvsLCgcw']
...
next_page_token=None
video_count=0
# my_file=open("pagefile.txt",'w+')
# next_page_token=my_file.readline()
# print('starting from page token:',next_page_token)
for pl_id in playlist_ids:
    while True:
        my_file=open("pagefile.txt",'w+')
        next_page_token=my_file.readline().strip()
