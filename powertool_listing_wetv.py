...
class PowertoolListingWetv(scrapy.Spider):
    name = "listing_wetv"
    filename = ""
    start_urls = []
    df_header = {
    ...
    def __init__(self, **kwargs):
        ...
        self.cat_id = (kwargs["link"].split("first_category=")[1]).split("&")[0]
    ...
    def closed(self, reason):
        self.output_dict[self.filename] = self.df
...
def main(output_dict):
    ...
    names = ["weTV-TV Drama", "weTV-Anime"]
